...
export class ClientesMapper {
  ...
  toClienteUpdate(clienteUpdateDto: UpdateClienteDto, cliente: Cliente): Cliente {
    const updatedCliente = ({...cliente, ...clienteUpdateDto , imagen: clienteUpdateDto.imagen ?? cliente.imagen});
